...
public class Button implements Clickable {
    ...
    /**
     * Implements the default behavior of this button when the mouse is released. This method must
     * be overridden in the sub-classes to implement a specific behavior if needed.
     */
    @Override
