...
/**
 * This class extends the PApplet class to create the treasure hunt game
 */
public class TreasureHunt extends PApplet {
    ...
    public static void main(String[] args) {
        ...
        // the PApplet.main() method takes a String input parameter which represents the name of
        // your PApplet class.
    }
    ...
    @Override
    public void setup() {
        this.focused = true; // Confirms that this graphic display window is "focused," meaning
        // that it is active and will accept mouse or keyboard input.
        this.imageMode(PApplet.CORNERS); // Interprets the x and y position of an image to the
        // position of its upper-left corner on the screen
        ...
        // of the upper left corner, and the third and fourth parameters as the position of the
        // opposite corner.rect() method draws a rectangle to the display window
    ...
    public void initGame() {
        // Create a new ArrayList of Clickable and assign its reference to the gameObjects
        // instance field
    ...
    private DroppableObject loadNewDroppableObject(String[] parts) {
        ...
        if (!(dropTarget instanceof InteractiveObject)) dropTarget = null;
        String message = parts[5].trim();
        InteractiveObject activate = null;
        if (parts.length > 6) activate = findObjectByName(parts[6].trim());
