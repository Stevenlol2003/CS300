...
/**
 * This class contains method needed for simulating a shopping cart that handles exceptions
 */
public class ExceptionalShoppingCart {
    ...
    protected static int parseCartSummaryLine(String line, String[] cart, int size)
        ...
        if (!(Integer.parseInt(parts[1]) > 0 && Integer.parseInt(parts[1]) <= 10)) {
            throw new DataFormatException("nbOccurrences not parsable to integer less or equal " +
                    "to" + " 10");
        }
